...
public class LoginBean extends BaseBean {
	...
	public String validateUserPassword(){
		...
		try {
			...
			FacesMessageUtils.addMessageErrorFromBundle(KEY_TITLE_SERVICE_ERROR, KEY_BODY_VALIDATE_USER, getResourceBundle());
			return "";
		}
		if(result){
			...
			FacesMessageUtils.addMessageErrorFromBundle(KEY_TITLE_LOGIN_WRONG, KEY_BODY_LOGIN_WRONG, getResourceBundle());
	...
	public void signIn(){
		...
		try{
			if(StringUtils.isEmpty(usernameRegister) 
					||StringUtils.isEmpty(passwordRegister)
					||StringUtils.isEmpty(firstNameRegister)
					||StringUtils.isEmpty(lastNameRegister)
					||StringUtils.isEmpty(emailRegister)){
				logger.debug("Alcuni campi obbligatori sono nulli!");
				FacesMessageUtils.addMessageErrorFromBundle(KEY_TITLE_REGISTER_WRONG, KEY_BODY_REGISTER_WRONG_FILED_EMPTY, getResourceBundle());
				return;
			}
